...
GRANT USAGE, CREATE ON SCHEMA "KeyMgr" TO keymgr_readwrite;

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA "KeyMgr"
GRANT ALL ON TABLES TO keymgr_global WITH GRANT OPTION;

ALTER DEFAULT PRIVILEGES FOR ROLE keymgr_readonly IN SCHEMA "KeyMgr"
GRANT SELECT ON TABLES TO keymgr_readonly;

ALTER DEFAULT PRIVILEGES FOR ROLE keymgr_readwrite IN SCHEMA "KeyMgr"
