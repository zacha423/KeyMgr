            ...
            <form method="post" action="{{ route('building.update', ['building' => $building['id']]) }}" class="mt-6 space-y-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <x-text-input id="name" name="name" type="text" class="form-control" :value="old('name', $building['name'])" />
                    ...
                    <div class="col-md-6">
                        ...
                        <x-text-input id="state" name="state" type="text" class="form-control" :value="old('state', $building['state'])" />
                        <x-input-error class="mt-2" :messages="$errors->get('state')" />
                    </div>

                    <div class="col-md-6">
                        <x-input-label for="city" :value="__('City')" />
                        <x-text-input id="city" name="city" type="text" class="form-control" :value="old('city', $building['city'])" />
                        <x-input-error class="mt-2" :messages="$errors->get('city')" />
                    </div>

                    <div class="col-md-6">
                        <x-input-label for="streetAddress" :value="__('Street')" />
                        <x-text-input id="streetAddress" name="streetAddress" type="text" class="form-control" :value="old('streetAddress', $building['streetAddress'])" />
                        <x-input-error class="mt-2" :messages="$errors->get('streetAddress')" />
                    </div>

                    <div class="col-md-6">
                        <x-input-label for="postalCode" :value="__('Zip')" />
                        <x-text-input id="postalCode" name="postalCode" type="text" class="form-control" :value="old('postalCode', $building['postalCode'])" />
